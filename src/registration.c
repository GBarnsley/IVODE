...
/* .C calls */
extern void cohort_static_model_initmod_desolve(void *);
extern void cohort_static_model_rhs_dde(void *);
extern void cohort_static_model_rhs_desolve(void *);
...
/* .Call calls */
extern SEXP cohort_static_model_contents(void *);
extern SEXP cohort_static_model_create(void *);
extern SEXP cohort_static_model_initial_conditions(void *, void *);
extern SEXP cohort_static_model_metadata(void *);
extern SEXP cohort_static_model_rhs_r(void *, void *, void *);
extern SEXP cohort_static_model_set_initial(void *, void *, void *, void *);
extern SEXP cohort_static_model_set_user(void *, void *);
...
static const R_CMethodDef CEntries[] = {
    {"cohort_static_model_initmod_desolve", (DL_FUNC) &cohort_static_model_initmod_desolve, 1},
    {"cohort_static_model_rhs_dde",         (DL_FUNC) &cohort_static_model_rhs_dde,         1},
    {"cohort_static_model_rhs_desolve",     (DL_FUNC) &cohort_static_model_rhs_desolve,     1},
...
static const R_CallMethodDef CallEntries[] = {
    {"cohort_static_model_contents",           (DL_FUNC) &cohort_static_model_contents,           1},
    {"cohort_static_model_create",             (DL_FUNC) &cohort_static_model_create,             1},
    {"cohort_static_model_initial_conditions", (DL_FUNC) &cohort_static_model_initial_conditions, 2},
    {"cohort_static_model_metadata",           (DL_FUNC) &cohort_static_model_metadata,           1},
    {"cohort_static_model_rhs_r",              (DL_FUNC) &cohort_static_model_rhs_r,              3},
    {"cohort_static_model_set_initial",        (DL_FUNC) &cohort_static_model_set_initial,        4},
    {"cohort_static_model_set_user",           (DL_FUNC) &cohort_static_model_set_user,           2},
